...
/** @type {string} */
const CACHE_VERSION = '1768738026|5045639385';
/** @type {string} */
const CACHE_PREFIX = 'DinoRUN-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DinoRUN.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DinoRUN.html","DinoRUN.js","DinoRUN.offline.html","DinoRUN.icon.png","DinoRUN.apple-touch-icon.png","DinoRUN.audio.worklet.js","DinoRUN.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DinoRUN.wasm","DinoRUN.pck"];
